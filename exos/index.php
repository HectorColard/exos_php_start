        ...
        <section class="section">
            <article class="exo">
                ...
                <div class="info">
                    ...
                    <ul>
                        ...
                        <li>
                            <a target="_blank" href="https://kourou.oclock.io/ressources/fiche-recap/les-fonctions-2/#d%c3%a9finir-une-fonction">Définir une fonction</a>
                        </li>
                    </ul>
                </div>
            </article>
            <article class="exo">
                ...
                <div class="info">
                    ...
                    <ul>
                        <li>
                            <a target="_blank" href="https://kourou.oclock.io/ressources/fiche-recap/les-conditions/">Les conditions en PHP</a>
                        </li>
                        <li>
                            <a target="_blank" href="https://kourou.oclock.io/ressources/fiche-recap/les-fonctions-2/#d%c3%a9finir-une-fonction">Définir une fonction</a>
                        </li>
            ...
            <article class="exo">
                ...
                <div class="info">
                    ...
                    <ul>
                        ...
                        <li>
                            <a target="_blank" href="https://kourou.oclock.io/ressources/fiche-recap/la-syntaxe-php/#compos%c3%a9-plusieurs-valeurs-scalaires">les tableaux (fiche récap)</a>
                        </li>
                    </ul>
                </div>
            </article>
            <article class="exo">
                <div class="summary">
                    ...
                    <p>
                        Une boucle simple ou une simple boucle ? Telle est la question<br>
                        Mais quelle qu'elle soit, elle permettra d'afficher les chiffres de 1 à 15<br>
                        Pourquoi pas de 10 à 45 vous demandez-vous ? Et bien parce que.
                    </p>
                </div>
                <div class="info">
                    <h3>Notions</h3>
                ...
                <div class="info">
                    ...
                    <ul>
                        <li>
                            <a target="_blank" href="https://kourou.oclock.io/ressources/fiche-recap/les-boucles/">les boucles (fiche récap)</a>
                        </li>
                    </ul>
                </div>
            </article>
            <article class="exo">
                <div class="summary">
                    ...
                    <h2>3 punitions</h2>
                    <p>
                        On ne va pas parler de Derrick, mais bien de Bart Simpson.<br>
                        En effet, il doit détenir le record de punitions à écrire au tableau<br>
                        => attention, le tableau de son école, pas le tableau de données PHP, hein ! ;)<br>
                        => même si, au final, ses punitions au tableau sont stockées dans un tableau !?? ¯\_(ツ)_/¯
                    </p>
                </div>
                <div class="info">
                    <h3>Notions</h3>
            ...
            <article class="exo">
                <div class="summary">
                    <div class="category">Bases de PHP</div>
                    <h2>Toutes les punitions</h2>
                    <p>
                        On a joué avec le tableau des punitions au tableau.<br>
                        Maintenant, on ne joue plus, et on affiche tout !
                    </p>
                </div>
                <div class="info">
                    <h3>Notions</h3>
                ...
                <div class="info">
                    ...
                    <ul>
                        ...
                        <li>
                            <a target="_blank" href="https://kourou.oclock.io/ressources/fiche-recap/la-syntaxe-php/#compos%c3%a9-plusieurs-valeurs-scalaires">les boucles (fiche récap)</a>
                        </li>
                    </ul>
                </div>
            </article>
            <article class="exo">
                <div class="summary">
                    <div class="category">Bases de PHP</div>
                    <h2>3 punitions et leur image</h2>
                    <p>
                        Le tableau a changé !<br>
                        Non, le tableau noir sur lequel Bart écrit ses punitions est toujours le même (quoique...)<br>
                        C'est le tableau des punitions au tableau qui a changé. Tu vois le tableau ?
                    </p>
                </div>
                <div class="info">
                    <h3>Notions</h3>
            ...
            <article class="exo">
                <div class="summary">
                    <div class="category">Bases de PHP</div>
                    <h2>Punitions en image</h2>
                    <p>
                        Tu peux mettre en page le tableau de punitions au tableau dans un tableau HTML,<br>
                        mais on ne table pas là-dessus.<br>
                        Tout ce qu'on veut, c'est voir afficher la punition et l'image associée
                    </p>
                </div>
                <div class="info">
                    <h3>Notions</h3>
